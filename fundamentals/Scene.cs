...
namespace RAYTRACER
{
    public class Scene
    {
        ...
        {   // position , intensity
            ...
            new Light(new Vector3(0, 0, -4), new Vector3(1f, 1f, 1f))
        };
            primitives = new List<Primitive>
        {
            // keep radius small when placing close to camera
            // x, y, z values are related, x and y can be larger when z is larger
            new Sphere(new Vector3(0, 0, -2), 2f, new Vector3(131,189,125), new Vector3(131,189,125)),
            //new Sphere(new Vector3(5, 0, 0), 2f, new Vector3(0,189,0), new Vector3(0,189,0)),
            //new Sphere(new Vector3(0, 0, -5), 2f, new Vector3(131,0,0), new Vector3(131,0,0)),
            //new Sphere(new Vector3(-5, 0, 0), 2f, new Vector3(0,0,125), new Vector3(0,0,125))
        };
        }
    }
}