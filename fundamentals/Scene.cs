...
namespace RAYTRACER
{
    public class Scene
    {
        ...
        Vector3 ambientLightingIntensity = new Vector3(1, 1, 1) / 255;
        ...
        public Scene()
        {
            ...
            {
                new Light(new Vector3(0, -2, 0), new Vector3(15, 15, 15)),
            ...
            primitives = new List<Primitive>
            {
                ...
                new Sphere(new Vector3(-2, 0, 5), 1f, new Vector3(255,0,0), new Vector3(255,0,0), true),
                //new Sphere(new Vector3(-5, 0, 0), 2f, new Vector3(180,180,255), new Vector3(180,180,255))
                new Plane(new Vector3(0, 0, 1), new Vector3(1, 0, 0), new Vector3(0, 4, 0), new Vector3 (0, 255, 0), new Vector3(0,0,255), texture:Primitive.Textures.Checkerboard),
